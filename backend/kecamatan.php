...
/** Mengecek apakah tombol simpan sudah di pilih/klik atau belum **/
	...
	mysqli_query($conn, "insert into kecamatan values('$kecamatanKODE', '$kecamatanNAMA', '$kabupatenKODE', '$namafoto')");
...
<form method="POST" enctype="multipart/form-data">
  <div class="row mb-3 mt-5">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="kecamatanKODE" name="inputKODE" placeholder="Kode Kecamatan Destinasi Wisata"> 
    </div>
  </div>
  <div class="row mb-3">
    <label for="kecamatanNAMA" class="col-sm-2 col-form-label">Nama Kecamatan</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="kecamatanNAMA" name="inputNAMA" placeholder="Nama Kecamatan Destinasi Wisata">
    </div>
  </div>
...
<!-- menampilkan data dari tabel kategori -->
    ...
    ?>
	    <?php while ($row = mysqli_fetch_array($query)) 	
            ...
            <td>
            <a href="kecamatan_update.php?ubahkecamatan=<?php echo $row["kecamatan_KODE"]?>" class="btn btn-success btn-sm" title="EDIT"> 
